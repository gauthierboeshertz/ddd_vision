...
class TestDataset():
    def __init__(self, cfg, device):
        ...
        self.seg_folder = cfg['seg_folder']
    ...
    def __getitem__(self, index):
        ...
        seg_path = self.seg_folder + img_name + '.npy'
        img_icon, img_hps, img_ori, img_mask, uncrop_param = process_image(img_path, self.det, self.hps_type, 512,seg_path=seg_path)
