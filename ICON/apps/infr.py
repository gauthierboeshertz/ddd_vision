...
if __name__ == '__main__':
    ...
    parser.add_argument('-seg_folder','--seg_folder', type=str,default=None)
    parser.add_argument('-in_dir', '--in_dir', type=str, default="../examples")
    parser.add_argument('-out_dir', '--out_dir', type=str, default="../results")
    parser.add_argument('-done_dir', '--done_dir', type=str, default="../already_processed/")
    ...
    cfg_show_list = [
        'test_gpus', [args.gpu_device], 'mcube_res', 512, 'clean_mesh', True
    ]
    ...
    for data in pbar:
        #if  os.path.isfile( f"{args.out_dir}/{cfg.name}/obj/{data['name']}_smpl.obj"):
        #    print('Data already excists mskn')
        #    continue
        ...
        for i in range(args.loop_smpl if cfg.net.prior_type != 'pifu' else 1):#loop_smpl:
       ...
       # loop_cloth = tqdm(range(args.loop_cloth))
        ...
        for i in range(args.loop_cloth):#loop_cloth:
        ...
        smpl_obj = trimesh.Trimesh(
            ...
            maintains_order=True,process=False)
        smpl_obj.export(
            f"{args.out_dir}/{cfg.name}/obj/{data['name']}_smpl.obj")

        shutil.move(data['img_path'], os.path.join(args.done_dir, data['img_path'].split("/")[-1] ))
